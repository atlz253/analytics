...
await esbuild.build({
  ...
  define: {
    ...
    "process.env.ARCHIVE_STORAGE_YS3_REGION": JSON.stringify(
      process.env.ARCHIVE_STORAGE_YS3_REGION!,
    ),
    "process.env.ARCHIVE_STORAGE_YS3_BUCKET_NAME": JSON.stringify(
      process.env.ARCHIVE_STORAGE_YS3_BUCKET_NAME!,
    ),
    "process.env.ARCHIVE_STORAGE_YS3_ACCESS_KEY_ID": JSON.stringify(
      process.env.ARCHIVE_STORAGE_YS3_ACCESS_KEY_ID!,
    ),
    "process.env.ARCHIVE_STORAGE_YS3_SECRET_ACCESS_KEY": JSON.stringify(
      process.env.ARCHIVE_STORAGE_YS3_SECRET_ACCESS_KEY!,
    ),
  },
});
