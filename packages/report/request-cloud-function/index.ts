...
export const handleUsersReport: Handler.Http = async (event) => {
  const queue = new SQS({
    region: "ru-central1",
...
export const handleUserReport: Handler.Http = async (event) => {
  const queue = new SQS({
    region: "ru-central1",
    endpoint: "https://message-queue.api.cloud.yandex.net",
    credentials: {
...
export const handleEventsReport: Handler.Http = async (event) => {
  const queue = new SQS({
    region: "ru-central1",
    endpoint: "https://message-queue.api.cloud.yandex.net",
    credentials: {
...
export const handleEventTypesReport: Handler.Http = async (event) => {
  const queue = new SQS({
    region: "ru-central1",
    endpoint: "https://message-queue.api.cloud.yandex.net",
    credentials: {
